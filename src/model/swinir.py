...
This is a state-of-the-art transformer-based model for image super-resolution.
"""
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim: int, input_resolution: Tuple[int, int], num_heads: int, window_size: int = 7,
                 shift_size: int = 0, mlp_ratio: float = 4., qkv_bias: bool = True, qk_scale: Optional[float] = None,
...
class SwinIR(nn.Module):
    ...
    def __init__(self, img_size: int = 64, patch_size: int = 1, in_chans: int = 3, embed_dim: int = 96,
                 depths: list = [6, 6, 6, 6], num_heads: list = [6, 6, 6, 6],
                 ...
                 use_checkpoint: bool = False, upscale: int = 2, img_range: float = 1., upsampler: str = '',
...
class SwinIRLarge(SwinIR):
    ...
    def __init__(self, upscale: int = 4, **kwargs):
        super().__init__(
            ...
            window_size=8, mlp_ratio=2, upscale=upscale, upsampler='pixelshuffle',
            **kwargs
        )


class SwinIRMedium(SwinIR):
    """Medium SwinIR model balancing quality and speed."""
    def __init__(self, upscale: int = 4, **kwargs):
        super().__init__(
            img_size=64, patch_size=1, in_chans=3, embed_dim=120,
...
class SwinIRSmall(SwinIR):
    """Small SwinIR model for fast inference."""
    def __init__(self, upscale: int = 4, **kwargs):
        super().__init__(
            img_size=64, patch_size=1, in_chans=3, embed_dim=60,
